					...
					spellAuraApplied = {
						...
						args = {
							...
							druid = { -- AuraApplied
								...
								order = 70,
								args = listOption({61336,50334,5229,2893,29166,22812,9846,27009,27006,17116,53312,22842},"auraApplied"),
							},
							hunter = { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 80,
								args = listOption({3045,19577,19263,19574,14311,34471,53480},"auraApplied"),
							},
							mage = { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 90,
								args = listOption({33946,33944,27128,32796,27131,12043,12042,12472,33405,12355,28682},"auraApplied"),
							},
							paladin = { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 110,
								args = listOption({642,6940,498,1044,5573,10278,1020,31892,31801,31884,20216,20375,20170,5589,31842,31821,64205,54428},"auraApplied"),
							},
							priest	= { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 120,
								args = listOption({15286,6346,33206,10060,14751,552,47585,47788},"auraApplied"),
							},
							rogue = { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 130,
								args = listOption({11305,51713,26669,31224,14177,13750,1833,11297,26884},"auraApplied"),
							},
							shaman	= { -- AuraApplied
								type = 'group',
								inline = true,
							...
							warlock	= { -- AuraApplied
								...
								order = 150,
								args = listOption({132,28610},"auraApplied"),
							},
							warrior	= { -- AuraApplied
								type = 'group',
								inline = true,
								...
								order = 160,
								args = listOption({55694,2687,871,18499,1719,23920,12292,12975,20230,12328,46924},"auraApplied"),
							},
							dk	= {
								type = 'group',
								inline = true,
					...
					spellAuraRemoved = {
						...
						args = {
							...
							druid = { -- AuraRemoved
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 60,
								args = listOption({29166,53201},"auraRemoved"),
							},
							hunter = { -- AuraRemoved
								type = 'group',
								inline = true,
							...
							mage = { -- AuraRemoved
								...
								name = L["|cff69CCF0Mage|r"],
								order = 80,
								args = listOption({12042,11129,12472,45438},"auraRemoved"),
							},
							paladin = { -- AuraRemoved
								type = 'group',
								inline = true,
								name = L["|cffF58CBAPaladin|r"],
								order = 100,
								args = listOption({498,642,25771,10278,20216,6940},"auraRemoved"),
							},
							priest	= { -- AuraRemoved
								type = 'group',
								inline = true,
								name = L["|cffFFFFFFPriest|r"],
								order = 110,
								args = listOption({6346,15286,33206,10060,14751,47585},"auraRemoved"),
							},
							rogue = { -- AuraRemoved
								type = 'group',
								inline = true,
...
--[[							bigHeal = { -- CastStart
							...
							druid = { -- CastStart
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 60,
								args = listOption({2637,18658,26989,33786,48465},"castStart"),
							},
							hunter = { -- CastStart
								type = 'group',
								inline = true,
							...
							priest	= { -- CastStart
								...
								name = L["|cffFFFFFFPriest|r"],
								order = 110,
								args = listOption({8129,9484,64843,605,10912,25380,32375},"castStart"),
							},
--[[							shaman	= { -- CastStart
								type = 'group',
								inline = true,
							...
							warlock	= { -- CastStart
								...
								name = L["|cff9482C9Warlock|r"],
								order = 140,
								args = listOption({30146,1122,6215,17928,30405,18647,30414,29893,27220,30908,30545,710,712,5138},"castStart"),
							},
--[[							warrior = { -- CastStart
								type = 'group',
								inline = true,
...
--[[							enemyInterrupts = { -- CastSuccess
							...
							druid = { -- CastSuccess
								...
								name = L["|cffFF7D0ADruid|r"],
								order = 70,
								args = listOption({1850,53201,8946,2782,8983,9913,33357,26993,33831,26983,18562},"castSuccess"),
							},
							hunter = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffABD473Hunter|r"],
								order = 80,
								args = listOption({5116,1543,14325,14311,34490,23989,27068,19503,27019,49050,13810},"castSuccess"),
							},
							mage = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cff69CCF0Mage|r"],
								order = 90,
								args = listOption({475,1953,2139,45438,27088,66,30449,11113,11958,31687,44445,44572,12051},"castSuccess"),
							},
							paladin = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffF58CBAPaladin|r"],
								order = 110,
								args = listOption({20271,1152,4987,10308,27154,33072,20066,31884},"castSuccess"),
							},
							priest	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffFFFFFFPriest|r"],
								order = 120,
								args = listOption({32548,528,988,10890,34433,25467,44047,32996,15487,64044,48173},"castSuccess"),
							},
							rogue = { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffFFF569Rogue|r"],
								order = 130,
								args = listOption({2094,8643,8696,11305,1787,26889,38764,38768,14278,14185,36554,51722,51724},"castSuccess"),
							},
							shaman	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cff0070daShaman|r"],
								order = 140,
								args = listOption({2484,526,8143,2870,8166,8177,8012,25454,8170,2062,2894,2825,16190,32182},"castSuccess"),
							},
--[[							shamanTotems	= { -- CastSuccess
							...
							warlock = { -- CastSuccess
								...
								name = L["|cff9482C9Warlock|r"],
								order = 150,
								args = listOption({27223,19647,48020,47860,6358},"castSuccess"),
							},
							warrior	= { -- CastSuccess
								type = 'group',
								inline = true,
								name = L["|cffC79C6EWarrior|r"],
								order = 160,
								args = listOption({676,5246,6554,29704,11578,25275,3411,12328,12809,2457,2458,71,6552,72},"castSuccess"),
							},
							dk	= {
								type = 'group',
								inline = true,
							...
							racials = {
								...
								order = 180,
								args = listOption({58984,26297,20594,33702,7744,28880,25046,50613,28730},"castSuccess"),
							},
						},
					},
				},
